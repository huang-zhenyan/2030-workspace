...
public class TestProduct {
	...
	public void test_product_1() {
		...
		/*
		 * Decimal numbers, when stored in computer memory, cannot be represented in binary perfectly.
		 * Instead, we should allow for some TOLERANCE of calculated results (ex +/- 0.1)
		 */
...
//		assertTrue(p.getModel() == "iPad Pro 12.9"); // This does not work always
