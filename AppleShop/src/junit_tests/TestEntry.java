...
//		assertEquals(e.getSerialNumber() == "F9DN4NKQ1GC"); //does not work because it compares addresses
	...
	public void test_entry_2() {
		...
		// change e's associated from p to p2.
		e.setProduct(p2);
		...
		// change e's associated from p2 to another object.
